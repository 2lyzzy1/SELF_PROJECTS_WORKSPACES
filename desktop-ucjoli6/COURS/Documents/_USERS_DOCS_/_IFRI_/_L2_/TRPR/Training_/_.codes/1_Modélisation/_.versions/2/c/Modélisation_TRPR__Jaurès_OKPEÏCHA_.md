...
graph TD;
    ...
    O --> Init;
    Init -->|"<span>$$(2M,\overrightarrow{G})$$</span>"| B["[(2M,G); (1M,3C,D)]"]; B -.-> X;
    Init -->|"<span>\((1M,\overrightarrow{G})\)</span>"| C["[(1M,G); (2M,3C,D)]"]; C -.-> X;

    Init -->|"<span>\((1C,\overrightarrow{G})\)</span>"| µF["[(1C,G); (3M,2C,D)]"]; µF -->|"<span>\((1C,\overrightarrow{D})\)</span>"| Init;
    Init -->|"<span>\((2C,\overrightarrow{G})\)</span>"| D["[(2C,G); (3M,1C,D)]"]; D -->|"<span>\((2C,\overrightarrow{D})\)</span>"| Init;

    D -->|"<span>\((1C,\overrightarrow{D})\)</span>"| F["[(1C,G); (3M,2C,D)]"]; F -->|"<span>\((1C,\overrightarrow{G})\)</span>"| D;

    Init -->|"<span>\((1C,1M,\overrightarrow{G})\)</span>"| E["[(1M,1C,G); (2M,2C,D)]"]; E -->|"<span>\((1C,1M,\overrightarrow{D})\)</span>"| Init;

    E -->|"<span>\((1C,\overrightarrow{D})\)</span>"| C;

    E -->|"<span>\((1M,\overrightarrow{D})\)</span>"| F; F -->|"<span>(1M,\overrightarrow{G})</span>"| E;

    F -->|"<span>\((1C,1M,\overrightarrow{G})\)</span>"| G["[(1M,2C,G); (2M,1C,D)]"]; G -.-> X;
    F -->|"<span>\((2M,\overrightarrow{G})\)</span>"| H["[(2M,1C,G); (1M,2C,D)]"]; H -.-> X;

    F -->|"<span>\((2C,\overrightarrow{G})\)</span>"| I["[(3C,G); (3M,D)]"]; I -->|"<span>\((2C,\overrightarrow{D})\)</span>"| F;
    
    I -->|"<span>\((1C,\overrightarrow{D})\)</span>"| dD;
    
    dD["[(2C,G); (3M,1C,D)]"] -->|"<span>\((1C,\overrightarrow{G})\)</span>"| I;
    dD -->|"<span>\((1M,\overrightarrow{G})\)</span>"| G;
    dD -->|"<span>\((1C,1M,\overrightarrow{G})\)</span>"| J["[(1M,3C,G); (2M,D)]"]; J -.-> X;

    dD -->|"<span>\((2M,\overrightarrow{G})\)</span>"| K["[(2M,2C,G); (1M,1C,D)]"]; K -->|"<span>\((2M,\overrightarrow{D})\)</span>"| dD;

    K -->|"<span>\((2C,\overrightarrow{D})\)</span>"| B;
    K -->|"<span>\((1C,\overrightarrow{D})\)</span>"| H;
    K -->|"<span>\((1M,\overrightarrow{D})\)</span>"| G;

    K -->|"<span>\((1C,1M,\overrightarrow{D})\)</span>"| eE["[(1M,1C,G); (2M,2C,D)]"]; eE -->|"<span>\((1C,1M,\overrightarrow{G})\)</span>"| K;

    eE -->|"<span>\((2C,\overrightarrow{G})\)</span>"| J;
    eE -->|"<span>\((1C,\overrightarrow{G})\)</span>"| G;
    eE -->|"<span>\((1M,\overrightarrow{G})\)</span>"| H;

    eE -->|"<span>\((2M,\overrightarrow{G})\)</span>"| L["[(3M,1C,G); (2C,D)]"]; L -->|"<span>\((2M,\overrightarrow{D})\)</span>"| eE;

    L -->|"<span>\((1M,\overrightarrow{D})\)</span>"| H;
    L -->|"<span>\((1C,1M,\overrightarrow{D})\)</span>"| B;

    L -->|"<span>\((1C,\overrightarrow{D})\)</span>"| Y["[(3M,G); (3C,D)]"]; Y -->|"<span>\((1C,\overrightarrow{G})\)</span>"| L;

    Y -->|"<span>\((2C,\overrightarrow{G})\)</span>"| M["[(3M,2C,G); (1C,D)]"]; M -->|"<span>\((2C,\overrightarrow{D})\)</span>"| Y;
    
    M -->|"<span>\((2M,\overrightarrow{D})\)</span>"| G;
    M -->|"<span>\((1C,1M,\overrightarrow{D})\)</span>"| H;

    M -->|"<span>\((1M,\overrightarrow{D})\)</span>"| kK["[(2M,2C,G); (1M,1C,D)]"]; kK -->|"<span>\((1M,\overrightarrow{G})\)</span>"| M;
    M -->|"<span>\((1C,\overrightarrow{D})\)</span>"| lL["[(3M,1C,G); (2C,D)]"]; lL -->|"<span>\((1C,\overrightarrow{G})\)</span>"| M;

    kK -->|"<span>\((1C,1M,\overrightarrow{G})\)</span>"| Goal;
    kK -->|"<span>\((1C,\overrightarrow{G})\)</span>"| N["[(2M,3C,G); (1M,D)]"]; N -.-> X;
    
    lL -->|"<span>\((2C,\overrightarrow{G})\)</span>"| Goal;
