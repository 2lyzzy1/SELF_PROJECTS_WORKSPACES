...
graph TD;
    ...
    A[["[(0,G); (3M,3C,D)]"]] -->|"<span>(1C,G)</span>"| µF["[(1C,G); (3M,2C,D)]"] -->|"<span>(1C,D)</span>"| A;
    ...
    eE -->|"<span>(2M,G)</span>"| L["[(3M,1C,G); (2C,D)]"] -->|"<span>(2M,D)</span>"| eE & E;
    ...
    kK -->|"<span>(1C,1M,G)</span>"| Goal["[(3M,3C,G); (0,D)]"];
